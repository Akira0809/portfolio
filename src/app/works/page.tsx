  ...
  const developmentWorks: DevelopmentWork[] = [
    {
      ...
      image: "/images/works/da_vinci_square.png",
    },
    {
      title: {
      ...
      image: "/images/works/apapane.png",
    },
    {
      title: {
    ...
    <>
      ...
      >
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-10 max-w-3xl">
          {t("works.developmentDescription") ||
            "担当した開発実績を紹介します。"}
        </p>
              ...
              <div className="flex-1">
                ...
                {work.client && (
                  <p className="text-sm mb-1">
                    {t("works.client")}: {work.client[language]}
                  </p>
                )}
                {work.projectType && (
                  <p className="text-sm mb-1">
                    {t("works.projectType")}: {work.projectType[language]}
                  </p>
                )}
                <p className="text-sm mb-1">
      ...
      <Section
        title={t("works.hackathonTitle") || "ハッカソン受賞歴"}
        translationKey="works.hackathonTitle"
      >
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-10 max-w-3xl">
          {t("works.hackathonDescription") ||
            "ハッカソンで受賞した実績をまとめています。様々な技術を活用し、短期間で革新的なプロダクトを開発した経験を紹介します。"}
        </p>
      ...
      <Section
        title={t("works.competitiveProgramming") || "競技プログラミング"}
        translationKey="works.competitiveProgramming"
        className="bg-gray-50 dark:bg-gray-900"
      >
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-10 max-w-3xl">
          {t("works.competitiveProgrammingDescription") ||
            "競技プログラミング関連の実績です。アルゴリズムやデータ構造の知識を活かし、効率的なコード設計能力を磨いています。"}
        </p>
